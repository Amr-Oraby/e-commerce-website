...
export default function OrderSummary({ data, nextStep }: OrderSummaryProps) {
  return (
    <div className="w-full md:w-140 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
      ...
      <Link
        ...
        className="w-full bg-[#111111] hover:bg-black text-white rounded-xl py-4 flex items-center justify-center gap-2 transition-colors"
      >
